export const COUNTRIES = [
  ...
  'Qatar', 'Bahrain', 'Kuwait', 'Oman', 'New Zealand', 'Ireland',
  'Sweden', 'Norway', 'Denmark', 'Finland', 'Switzerland', 'Japan',
  'South Korea', 'China', 'Bangladesh', 'Pakistan', 'Sri Lanka', 'Nepal',
  'Other',
];
...
export const DISTRICTS_BY_STATE = {
  ...
  Chhattisgarh: [
    ...
    'Koriya', 'Mahasamund', 'Manendragarh-Chirmiri-Bharatpur', 'Mungeli', 'Narayanpur',
  ...
  Rajasthan: [
    ...
    'Dausa', 'Deeg', 'Dholpur', 'Dungarpur', 'Hanumangarh', 'Jaipur', 'Jaipur Rural',
    'Jaisalmer', 'Jalore', 'Jhalawar', 'Jhunjhunu', 'Jodhpur', 'Jodhpur Rural',
    'Karauli', 'Kekri', 'Kota', 'Nagaur', 'Pali', 'Pratapgarh', 'Rajsamand',
