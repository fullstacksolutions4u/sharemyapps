      ...
      >
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex flex-wrap gap-2 pt-2 border-t border-[#E5E1DA]">
            ...
            {u.linkedinUrl && <a href={u.linkedinUrl} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 px-3 py-2 bg-[#0A66C2] text-white rounded-xl text-xs font-medium hover:bg-[#004182] transition"><LinkedInIcon size={12} />LinkedIn</a>}
            {u.githubUrl && <a href={u.githubUrl} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 px-3 py-2 bg-[#24292F] text-white rounded-xl text-xs font-medium hover:bg-[#3D444D] transition"><GithubIcon size={12} />GitHub</a>}
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex gap-2">
            ...
            {u.linkedinUrl && <a href={u.linkedinUrl} target="_blank" rel="noreferrer" title="LinkedIn" onClick={e => e.stopPropagation()}
              className="p-2 bg-[#F3F0EB] rounded-xl hover:bg-[#0A66C2] hover:text-white text-[#6B7280] transition"><LinkedInIcon size={13} /></a>}
            {u.githubUrl && <a href={u.githubUrl} target="_blank" rel="noreferrer" title="GitHub" onClick={e => e.stopPropagation()}
              className="p-2 bg-[#F3F0EB] rounded-xl hover:bg-[#24292F] hover:text-white text-[#6B7280] transition"><GithubIcon size={13} /></a>}
