    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-6 py-4">
      <div className="flex items-center gap-16">
        ...
        <div className="w-full max-w-3xl">
          ...
          <h1 className="text-2xl font-bold text-text tracking-tight mb-4 lg:hidden">Create your account</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 border border-border rounded-xl text-sm text-text placeholder-[#9CA3AF] focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/10 transition"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 pr-10 border border-border rounded-xl text-sm text-text placeholder-[#9CA3AF] focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/10 transition"
                  />
                  <button type="button" onClick={() => setShowPassword(v => !v)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-[#9CA3AF] hover:text-muted transition-colors">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-accent hover:bg-accent-hover text-white py-2.5 rounded-xl font-medium text-sm transition-colors disabled:opacity-60"
              >
