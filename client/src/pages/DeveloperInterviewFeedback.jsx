        ...
        return (
          <div key={session._id} className="bg-white rounded-3xl border border-border overflow-hidden shadow-sm">
            ...
            <button
              ...
              className="w-full text-left bg-gradient-to-r from-[#0F172A] to-[#1E293B] p-6 text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 hover:from-[#1E293B] hover:to-[#334155] transition-colors focus:outline-none"
            >
              <div>
                <h2 className="text-xl font-bold">
                  Interview Feedback for {session.vacancy?.title || 'Developer'} | {new Date(session.interviewedAt).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}
                </h2>
              </div>
