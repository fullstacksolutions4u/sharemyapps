    ...
    <div className="min-h-screen bg-bg flex flex-col items-center justify-start px-4 pt-3 sm:pt-5 pb-8 relative">
      <div className="w-full max-w-3xl">
        ...
        <div className="text-center mb-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-[#1E3A5F] tracking-tight mb-3">
            Welcome, {user.name.split(' ')[0]}!
          </h1>
          <p className="text-[#3B5973] text-sm font-medium">
            Tell us who you are so we can tailor your experience.
          </p>
        </div>

        {/* Square Role Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6 animate-in fade-in slide-in-from-bottom-4">
              ...
              >
                ...
                <div className="w-full flex justify-end">
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
                    isSelected ? `${border} ${bg}` : 'border-[#3B5973]/40'
                  }`}>
